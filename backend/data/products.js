//this script will import data into our database
...
const products = [
    ...
    },
    {
      ...
      imageUrl:
       "https://i.ibb.co/3R56Jvg/Tripod.jpg" ,
      description:"It has 4 section legs and it’s very light and convenient. It is designed for part-time photography lovers. Help them to take a high-quality scene or group photos without motion and long-time human hand-holding.",
      price: 350,
      countInStock: 11,
    },
    {
      ...
      imageUrl:
        "https://i.ibb.co/1vtcRcb/oneplus.png",
      description:"OnePlus Smart Band: 13 Exercise Modes, Blood Oxygen Saturation (SpO2), Heart Rate & Sleep Tracking, 5ATM+Water & Dust Resistant( Android & iOS Compatible).",
      price: 2499,
      countInStock: 14,
    },
